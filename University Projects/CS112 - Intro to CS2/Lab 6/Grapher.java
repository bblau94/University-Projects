 ...
 *                  public void drawCurve(int [] A);                   // A is of form [x1, f(x1), ..., xn, f(xn)]
 *                                                                     // and these points will be connected by curve
 *                  public void labelCurve(String s);                  // Put a string near the curve
 * 
...
public class Grapher {
   ...
   private Color [] colors = { Color.blue, Color.red, Color.black, Color.green }; 
   private int cNumber = 0; 
   private int labelX = 80;
   private int labelY = 800; 
